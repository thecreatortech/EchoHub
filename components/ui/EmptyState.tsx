			...
			<div className='flex-center w-full max-w-[254px] flex-col gap-3'>
				...
				{search && (
					<p className='text-16 text-center font-medium text-white-2'>
						Try adjusting your to find what youra are looking for
					</p>
				)}
				...
				{buttonLink && (
					<Button className='bg-orange-1'>
						...
						<Image src='/icons/discover.svg' width={20} height={20} alt='discvoer' />
						<h1 className=' pl-2 text-16 font-extrabold text-white-1'>{buttonText}</h1>
					</Button>
				)}
			</div>
		</section>
